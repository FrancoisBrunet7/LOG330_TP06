 ...
 * @author Francois
 *
 *Demande à l'utilisateur de choisir un fichier avec un extension .csv.
...
public class FileSelector extends Observable {
	...
	public void chooseAFile() {
		...
		JOptionPane.showMessageDialog(null, "Veuillez choisir le fichier .csv contenant les données dont vous désirez connaître la variance et l'écart-type.");
